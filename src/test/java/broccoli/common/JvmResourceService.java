...
/**
 * The {@link JvmResourceService}.
 */
@Singleton
public final class JvmResourceService implements ResourceService {
  ...
  @Inject
  public JvmResourceService(EdgeRepository edgeRepository, VertexRepository vertexRepository) {
